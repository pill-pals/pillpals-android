...
import com.pillpals.pillpals.ocrreader.ui.camera.CameraSourcePreview;
...
public final class OcrCaptureActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        SpannableString pinchText = new SpannableString("Tap to Select. Pinch/Stretch to zoom");
        pinchText.setSpan(
            new ForegroundColorSpan(this.getResources().getColor(R.color.colorLightGrey)),
        0,
            pinchText.length(),
            Spanned.SPAN_EXCLUSIVE_EXCLUSIVE
        );
        Snackbar.make(graphicOverlay, pinchText,
